...
public class FriendPatch {
    ...
    public static class HighlightFriendsPatch {
    ...
    @SpirePatch2(clz = DailyScreen.class, method = "determineLoadout")
    public static class DisableEmbarkPatch {
        @SpirePostfixPatch
        public static void DisableEmbarkButton(DailyScreen __instance, @ByRef ConfirmButton[] ___confirmButton) {
            ___confirmButton[0].isDisabled = true;
            ___confirmButton[0].hide();
        }
